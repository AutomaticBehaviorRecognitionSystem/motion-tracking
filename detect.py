...
def vis_detections(im, class_name, dets, thresh=0.5, index=1):
    ...
    f_detected = open('detected{}.txt'.format(index), 'w')
    for i in inds:
...
if __name__ == '__main__':
    ...
    if video:
        ...
        for i in range(0, frame_count, 50):
            demo(net, image, ('sheep',), video=True, frame=i)
    else:
        demo(net, image, ('sheep',), video=False)
